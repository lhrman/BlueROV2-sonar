...
class TimestampEstimator {
    ...
    * to double again.
    */
   void internalReset(double window, double initial_period, double min_latency,
  ...
  public:
    ...
    */
   TimestampEstimator(base::Time window, base::Time initial_period,
                      base::Time min_latency, int lost_threshold = 2);
   TimestampEstimator(base::Time window, base::Time initial_period,
                      int lost_threshold = 2);
   ...
   /** @overload
    */
   void reset(base::Time window, base::Time initial_period,
              int lost_threshold = 2);
