 ...
 * expect <li> implement extractPacket (see below)
 * </ul>
 *
...
class Driver {
  ...
  public:
   ...
   /** wheter or not publish debug messages
    */
   bool debug_;
  ...
  public:
    ...
    */
   Driver(int max_packet_size, bool extract_last = false, bool debug = false);
    ...
    * from the input port.
    */
   void openUDPBidirectional(std::string const& hostname, int remote_port,
                             int local_port, bool ignore_connrefused,
                             bool connected, bool ignore_hostunreach = true,
