...
struct Sonar {
  public:
   ...
   Sonar(base::Time time, base::Time bin_duration, int bin_count,
   ...
   Sonar(base::Time time, base::Time bin_duration, int bin_count,
         base::Angle beam_width, base::Angle beam_height, int beam_count,
    ...
    */
   static Sonar fromSingleBeam(base::Time time, base::Time bin_duration,
                               base::Angle beam_width, base::Angle beam_height,
                               std::vector<float> const& bins,
                               base::Angle bearing = base::Angle(),
   ...
   /** Add data for one beam
    */
   void pushBeam(base::Time const& beam_time,
                 std::vector<float> const& beam_bins);

   /** Add data for one beam
    */
   void pushBeam(base::Time const& beam_time,
                 std::vector<float> const& beam_bins, base::Angle bearing);
   ...
   /** Add data for one beam
    */
   void setBeam(unsigned int beam, base::Time const& beam_time,
                std::vector<float> const& beam_bins);
