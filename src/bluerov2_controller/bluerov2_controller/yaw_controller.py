...
class Contyawer(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("yaw_desired", 0.0) 
        self.declare_parameter("pwm_max", 1750.0) 
        self.declare_parameter("pwm_neutral", 1500.0)            
        self.declare_parameter("kp", 550.0)    
        ...
        self.yaw_desired        = self.get_parameter("yaw_desired").value
    ...
    def callback_set_yaw(self, msg):
        self.yaw_desired = float(msg.data)           
